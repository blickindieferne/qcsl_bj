...
<div class="menu_left">
  ...
  <div id="search_box" class="search_box" >
    <form id="form1" name="form1" action="${path}/policy/saveYPrice.do" method="post">
     <div class="title" style="width: 82px;">修改Y舱价格</div>
     
     <div style="width: 82px;"><a class="opt_a" href="javascript:back();">返回列表</a></div>
    <div class="search_panel" style="margin-top: 10px;">
    <input type="hidden" id="id" name="id" value="${yPrice.id }"/>
	      <table class="search_table">
	        <tr>
	          <td>航空公司：</td>
	          <td><input type="text" id="flightcode" name="flightcode" value="${yPrice.flightcode }"/></td>
	         <td>起飞城市：</td>
	          <td><input type="text" id="dpt" name="dpt" value="${yPrice.dpt }"/></td>
	        </tr>
	        <tr>
	        	<td>到达城市：</td>
	          <td><input type="text" id="arr" name="arr" value="${yPrice.arr }"/></td>
	         <td>Y舱价格：</td>
	          <td><input type="text" id="price" name="price" value="${yPrice.price }"/></td>
	        </tr>
  ...
  function back(){
	  $portal.closePage(window._changed);
  }
